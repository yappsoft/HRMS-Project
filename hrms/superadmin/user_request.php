  ...
  <!---- start show data in row loop -->
   ...
   <!--- on click  redirect to usefull info page on click event not in href --> 
    <tr id="tr" onclick="crt('<?php echo $row['company_id'];?>')" >
      ...
      <td><img height="25px" onclick="Confirm_acc('<?php echo $row['company_id'];?>')" src="../images/edit1.png">
      <td><img height="25px" onclick="rej_acc('<?php echo $row['company_id'];?>')" src="../images/delete-icon.png">
	  </td>
    </tr>
    <?php
}?>
