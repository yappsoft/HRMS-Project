                 ...
                 <form methode="post" id="update_holiday" class="ng-pristine ng-valid">
                   ...
                   <div class="col-sm-12 col-md-12 col-lg-12 text-center">
                       ...
                       <ul class="tenantform" style="margin-left: -185px">
                           <li><button id="edit_hld" type="submit" style="padding: 10px 20px;
                      ...
                      submitHandler: upt 
                                  ...
                                  function upt(){
                                    var data = $('#update_holiday').serialize();
                                     $("#add_hld").text('');
                                 $("#edit_hld").css({'background': '#fff', 'opacity': '.5'});
                                  $("#edit_hld").append("<img src='../images/loader.gif' />");
                                    $.ajax({
                                     type: 'POST',
