...
$query = mysqli_query($con,"insert into employee_tbl(company_id,com_emp_id,first_name,last_name, email, password, education, date_of_birth, mobile_no, alternate_no, family_no, local_address, permanent_address  , account_no, ifsc_code, date_of_joining, bank_name, bank_branch_name, number_of_leaves,department) values ('$company_id','$com_emp_id2','$first_name2','$last_name2','$email2','$password2','$education2','$date_of_birth2','$mobile_no2','$alternate_no2','$family_no2','$local_address2','$permanent_address2','$account_no2','$ifsc_code2','$date_of_joining2','$bank_name2','$bank_branch_name2','$number_of_leaves2','$department2')");
